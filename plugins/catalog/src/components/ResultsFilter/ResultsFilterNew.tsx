...
import { useEntityListState, applyFilter, removeFilter } from '../../state';
 ...
 */
export const ResultsFilterNew = ({ availableTags }: Props) => {
  const classes = useStyles();
  const { state, dispatch } = useEntityListState();

  const tagFilterId = 'metadata.tags';
  const selectedTags = state.filters[tagFilterId]?.values ?? [];
